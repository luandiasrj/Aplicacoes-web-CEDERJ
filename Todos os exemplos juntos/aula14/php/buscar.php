...
<?php
//
// Módulo para buscar e solicitar livros.
//

require_once ("formlivro.php");

// Vejo se o formulário foi postado
if (isset ($_POST["enviar_busca_livro"])) {
	...
	$link = "<a href='index.php?acao=solicitar&id=%d'>%s</a>";
    ...
    form_busca_livro ("index.php?acao=buscar", $_POST);
}
?>
